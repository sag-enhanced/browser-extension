if(window.location.hash.startsWith("#sag/")) {
    ...
    css.innerText = `#global_header{display:none;}.footer{display:none;}.section_title{display:none;}.row_flex{display:none !important;}.form_row:last-child{display:none;}`;
